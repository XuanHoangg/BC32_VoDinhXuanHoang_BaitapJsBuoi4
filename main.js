 ...
 *  - Process : viết câu điêu kiện if-else 6 trường hợp
 *          + Th1: st1 > st2 > st3 : in ra lần lượt st3,st2,st1
 *          + Th2: st1 > st3 > st2 : in ra lần lượt st2,st3,st1
 ...
 *      - Process : Sử dụng câu lệnh điều kiện if-else 
 ...
 *    - Process : Kiểm tra chẵn lẻ các số bằng cách chia lấy dư cho 2
 *                Tạo 1 biến chan và 1 biến le
 ...
 *      - Process : Dùng câu lệnh điều kiện if-else để kiểm tra 3 cạnh tam giác
